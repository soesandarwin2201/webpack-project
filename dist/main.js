...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _add_remove_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-remove.js */ \"./src/add-remove.js\");\n/* harmony import */ var _render_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./render.js */ \"./src/render.js\");\n\r\n\r\n\r\n\r\n// const LOCAL_STORAGE = 'task.listArray';\r\nconst listArray = JSON.parse(localStorage.getItem('listArray')) || [] ;\r\n\r\n\r\n\r\nconst container = document.getElementById('container');\r\nconst form = document.getElementById('form');\r\nconst listInput = document.getElementById('list-input');\r\nconst alert  = document.getElementById('alert');\r\n\r\n\r\n\r\n\r\n\r\nform.addEventListener('submit', (e) => {\r\n  e.preventDefault();\r\n  const listName = listInput.value;\r\n\r\n  if( listName === null || listName === '') {\r\n    console.log('it is empty');\r\n    return undefined;\r\n  }\r\n  else {\r\n    const list = (0,_add_remove_js__WEBPACK_IMPORTED_MODULE_1__.addList)(listName);\r\n    listArray.push(list);\r\n    (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.render)();\r\n    listInput.value = null;\r\n  \r\n  }\r\n  localStorage.setItem('listArray', JSON.stringify(listArray));\r\n\r\n});\r\n\r\n\r\nwindow.addEventListener('DOMContentLoaded', _render_js__WEBPACK_IMPORTED_MODULE_2__.render);\r\n\r\ncontainer.addEventListener('click', (e) => {\r\n  (0,_add_remove_js__WEBPACK_IMPORTED_MODULE_1__.deleteList)(e.target);\r\n  (0,_add_remove_js__WEBPACK_IMPORTED_MODULE_1__.trashIcon)(e.target);\r\n  (0,_add_remove_js__WEBPACK_IMPORTED_MODULE_1__.removeLocalStorage)(e.target.dataset.id)\r\n});\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\n\n//# sourceURL=webpack://webpack-project/./src/index.js?");
